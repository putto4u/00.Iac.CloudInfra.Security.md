...
# - 인프라 및 보안 (3번)       : 150 MB
# - Python 웹 스택 (4번)       : 660 MB (사용여부 선택설치)
# - 멀티 DB 클라이언트 (5번)   : 460 MB (DB 선택 설치)
# - K8s, IaC 및 Nginx (6번)    : 410 MB (단계별 선택설치)
# - CI/CD 및 자동화 (7번)      : 200 MB (단계별 선택설치)
# - Java 개발 스택 (8번)       : 510 MB (대용량/선택 설치)
# - AWS Cloud SDK (9-1번)      : 550 MB (대용량/선택 설치)
# - Azure Cloud SDK (9-2번)    : 680 MB (대용량/선택 설치)
# - Google Cloud SDK (9-3번)   : 320 MB (대용량/선택 설치)
# - AI/ML 프레임워크 (10번)    : 2,870 MB (대용량/선택 설치)
#
# 최초 빌드 예상시간 : 약 30분 ~ 45분
#  재  빌드 예상시간 : 1분 내외
#  run time 예상시간 : 3~20초
# -----------------------------------------------------------------
#
